 ...
 */
// esta clase es un grafo dirigido
public class Grafo <Clave, InfoVertice, Coste> {
	...
	private Lista< Lista<NodoArista> > aristas; // lista de adyacencia (listas de listas)

	public Grafo() { //crea grafo vacio, tiene sus dos listas vacias
	...
	//llega al ultimo elemento del camino
